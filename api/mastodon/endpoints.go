...
const (
	...
	endpointAccounts         shared.Endpoint = "/api/v1/accounts/:id"
	endpointRelationships    shared.Endpoint = "/api/v1/accounts/relationships"
	endpointAccountsSearch   shared.Endpoint = "/api/v1/accounts/search"
	endpointAccountsStatuses shared.Endpoint = "/api/v1/accounts/:id/statuses"
